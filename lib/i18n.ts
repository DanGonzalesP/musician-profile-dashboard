...
export const dictionaries: Record<Locale, Dict> = {
  es: {
    ...
    feed_comments_none_active: "Reproduce una canción para ver y escribir comentarios sobre ella.",
  ...
  en: {
    ...
    feed_comments_none_active: "Play a song to see and write comments on it.",
