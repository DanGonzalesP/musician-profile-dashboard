...
import type { Block, HeroData, SingleData, CrowdfundingData, TracksData, CreditsData, MerchData, ServiceData, LegadoData, PublicacionesData, EmbedsData } from "@/lib/blocks"
