...
const TrackScreen = forwardRef<HTMLDivElement, TrackScreenProps>(function TrackScreen(
  ...
  return (
    <section
      ref={ref}
      className="relative flex h-dvh w-full snap-start snap-always justify-center overflow-hidden pb-28 pl-20 pr-6 pt-48 [align-items:safe_center] lg:px-6 lg:pt-24"
    >
      {track.coverImageUrl && (
        <div
          aria-hidden
