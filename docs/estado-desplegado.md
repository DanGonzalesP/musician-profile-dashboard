...
| **0014_explicitar_rls_respaldo_privado** (F0) | 🟡 verificada localmente; pendiente de producción | Política deny-all explícita para el respaldo ya privado |
| **0015_cuotas** (F11) | ⬜ ni escrita — necesita la decisión de cuota (§8 #19) | | |
| **0016_moderacion_operativa** (F14) | ⬜ ni escrita — necesita decidir cómo se representa un administrador **en la base** (hoy `ADMIN_USER_IDS` sólo existe en el entorno de la app) | | |
